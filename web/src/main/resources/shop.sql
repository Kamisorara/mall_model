...
-- ----------------------------
INSERT INTO `shop_recommended` VALUES (1, 'MSI/微星RTX 3060', 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/654519625/O1CN01L4xb8s2KyIt2aPRJL_!!0-item_pic.jpg_580x580Q90.jpg_.webp', 3599.00, 999, 999);
INSERT INTO `shop_recommended` VALUES (2, '七彩虹RTX3060/3060TI', 'https://g-search2.alicdn.com/img/bao/uploaded/i4/i4/3918712328/O1CN01Dgtlcp1T4GnUp8kXu_!!0-item_pic.jpg_580x580Q90.jpg_.webp', 3499.00, 333, 444);
INSERT INTO `shop_recommended` VALUES (3, '华硕ROG猛禽RTX3060', 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/2210835472380/O1CN01VreFtP1TS5OMe5Eio_!!0-item_pic.jpg_580x580Q90.jpg_.webp', 2849.00, 444, 444);
INSERT INTO `shop_recommended` VALUES (4, '七彩虹RTX3080/', 'https://g-search1.alicdn.com/img/bao/uploaded/i4/i1/2133729733/O1CN01Bd2jO02LllfAvf7vU_!!0-item_pic.jpg_580x580Q90.jpg_.webp', 9199.00, 333, 333);
INSERT INTO `shop_recommended` VALUES (5, '影驰RTX3080/Ti', 'https://g-search1.alicdn.com/img/bao/uploaded/i4/i1/2651871058/O1CN01ytqlo91JgbmPyVHqN_!!0-item_pic.jpg_580x580Q90.jpg_.webp', 9300.00, 444, 444);
INSERT INTO `shop_recommended` VALUES (6, '七彩虹RTX3070/Ti', 'https://g-search1.alicdn.com/img/bao/uploaded/i4/i4/2133729733/O1CN01eYLZYr2Lllf7DLy2W_!!0-item_pic.jpg_580x580Q90.jpg_.webp', 4599.00, 555, 555);
INSERT INTO `shop_recommended` VALUES (7, '猛禽RTX3090/3090TI', 'https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/654519625/O1CN01izYfVL2KyIt19oPoC_!!0-item_pic.jpg_580x580Q90.jpg_.webp', 12999.00, 111, 1111);
INSERT INTO `shop_recommended` VALUES (8, '英伟达NVIDIA公版无锁', 'https://g-search2.alicdn.com/img/bao/uploaded/i4/i1/3971128232/O1CN01MXBMol2AgJ67nn97y_!!0-item_pic.jpg_580x580Q90.jpg_.webp', 7299.00, 111, 111);
INSERT INTO `shop_recommended` VALUES (9, '影驰RTX3090名人堂', 'https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/2681126335/O1CN01jwyrX21wfTpYDl0oN_!!0-item_pic.jpg_580x580Q90.jpg_.webp', 6899.00, 333, 333);
INSERT INTO `shop_recommended` VALUES (10, '电竞叛客RTX3060', 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/3690358924/O1CN010WKGeb2FnFFGkwI0L_!!0-item_pic.jpg_580x580Q90.jpg_.webp', 2799.00, 555, 555);
...
CREATE TABLE `shop_seller`  (
  ...
  `seller_marl1` int(2) UNSIGNED ZEROFILL NOT NULL COMMENT '描述分',
  `seller_mark2` int(2) UNSIGNED ZEROFILL NOT NULL COMMENT '服务分',
  `seller_mark3` int(2) UNSIGNED ZEROFILL NOT NULL COMMENT '物流分',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `shop_seller` VALUES (1, 'Kamisora官方店', 05, 05, 05);
...
CREATE TABLE `sys_user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1524762184922480641 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1524761813231648769, 'Kamisora', 'NULL', '$2a$10$THVL/RRLI5kjYiaUZBqX1e0vH5OBd5sYfVMP1XBYNbWsV3kllTx3y', '0', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_user` VALUES (1524762184922480641, 'wyf', 'NULL', '$2a$10$hFfulETdfxaBlJRj.hZtx..Fu0aQbql0nnmcdGghZbBFr2XPbXRBa', '0', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 0);
